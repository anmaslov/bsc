...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { content: @catalog.content, description: @catalog.description, image_url: @catalog.image_url, keywords: @catalog.keywords, parent_id: @catalog.parent_id, title: @catalog.title }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { content: @catalog.content, description: @catalog.description, image_url: @catalog.image_url, keywords: @catalog.keywords, parent_id: @catalog.parent_id, title: @catalog.title }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
